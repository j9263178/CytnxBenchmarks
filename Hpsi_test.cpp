...
// BENCHMARK(itensor_Hpsi_dense_)->Arg(64);
// BENCHMARK(itensor_Hpsi_dense_)->Arg(100);
// BENCHMARK(itensor_Hpsi_dense_)->Arg(200);
// BENCHMARK(itensor_Hpsi_dense_)->Arg(300);
// BENCHMARK(itensor_Hpsi_dense_)->Arg(600);
// BENCHMARK(itensor_Hpsi_dense_)->Arg(1000);

// BENCHMARK(Cytnx_Hpsi_dense_)->Arg(64);
// BENCHMARK(Cytnx_Hpsi_dense_)->Arg(100);
// BENCHMARK(Cytnx_Hpsi_dense_)->Arg(200);
// BENCHMARK(Cytnx_Hpsi_dense_)->Arg(300);
// BENCHMARK(Cytnx_Hpsi_dense_)->Arg(600);
// BENCHMARK(Cytnx_Hpsi_dense_)->Arg(1000);
...
BENCHMARK(Cytnx_Hpsi_U1_D2000);
// BENCHMARK(Cytnx_Hpsi_U1_D1000);
// BENCHMARK(Cytnx_Hpsi_U1_D3000);
...
// BENCHMARK(itensor_Hpsi_U1_D1000);
// BENCHMARK(itensor_Hpsi_U1_D1000);
// BENCHMARK(itensor_Hpsi_U1_D3000);
