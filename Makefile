...
# $(info $$CYTNX_CXXFLAGS is [${CYTNX_CXXFLAGS}])
...
# CYTNX_CXXFLAGS:=-I/home/petjelinux/anaconda3/envs/cytnx/include -march=native -ftree-vectorize -O3 -std=c++17 -pipe -isystem /home/petjelinux/anaconda3/envs/cytnx/include -Wformat=0 -Wno-c++11-narrowing -w -fopenmp
...
HDF5_PREFIX=/home/petjelinux/anaconda3/envs/cytnx
...
#	$(CC) $(CYTNX_CXXFLAGS) -I$(BENCHMARK_HEADER) -I${CYTNX_INC}  $< -L$(BENCHMARK_SRC) ${CYTNX_LIB} ${CYTNX_LINK} -I$(ITENSOR_ROOT) -O2 -DNDEBUG -Wall -L$(ITENSOR_LIBDIR) -litensor -lbenchmark -fsanitize=address -o $@
	$(CC) -Wl,--as-needed -Wl,--allow-shlib-undefined $(CYTNX_CXXFLAGS) -I$(BENCHMARK_HEADER) -I${CYTNX_INC}  $< -L$(BENCHMARK_SRC) ${CYTNX_LIB} ${CYTNX_LINK} -I$(ITENSOR_ROOT) -O2 -DNDEBUG -Wall -L$(ITENSOR_LIBDIR) -litensor -lbenchmark -o $@
#clean
.phony: clean
